...
static int test_motor3 = 6;
static int test_motor4 = 7;
...
void setup() {
  ...
  pinMode(test_motor3, OUTPUT);
  pinMode(test_motor4, OUTPUT);
}
...
void loop() {
  ...
  motor_control(test_motor3, test_motor4, target_speed);
}
